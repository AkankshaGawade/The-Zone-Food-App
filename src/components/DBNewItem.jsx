...
const DBNewItem = () => {
  ...
  const uploadImage = (e) => {
    ...
    const storageRef = ref(storage, `Image/${Date.now()}_${imageFile.name}`);
  ...
  return (
    <div className="flex items-center justify-center flex-col pt-4 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4">
        ...
        <motion.button onClick={submitNewData} {...buttonClick} className="w-9/12 py-2 rounded-md bg-red-400 text-primary cursor-pointer">
          Save
        </motion.button>
      </div>
    </div>
  ...
  return (
    <>
      <input
        ...
        className="w-full px-4 py-3 bg-slate-000 shadow-md outline-none rounded-md border border-gray-200 focus:border-red-400"
        value={stateValue}
