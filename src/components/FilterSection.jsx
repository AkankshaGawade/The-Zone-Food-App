    ...
    <motion.div className="w-full flex items-center justify-start flex-col">
      <div className="w-full flex items-center justify-between">
        <div className="flex flex-col items-start justify-start gap-1">
          <p className="text-2xl text-headingColor font-bold">Hot Dishes</p>
...
export const FilterdCard = ({ data, index, category, setCategory }) => {
  return (
    <motion.div
      key={index}
    ...
    >
      ...
      <p
        className={`text-xl font-semibold ${
          category === data.category ? "text-red-500" : "text-textColor"
        } group-hover:text-red-500`}
      >
        {data.category}
      </p>
